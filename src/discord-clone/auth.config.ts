...
export const authConfig = {
    ...
    callbacks: {
        ...
        // via Next.js Middleware. It is called before a request is completed, and it receives an object 
        // with the auth and request properties. The auth property contains the user's session, 
